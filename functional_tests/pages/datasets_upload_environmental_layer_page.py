...
class DatasetsUploadEnvironmentalLayerPage(DatasetsTabPage):
    ...
    def select_dataset_genre(self, genre):
        select = Select(self.driver.find_element_by_name("addlayer.widgets.datagenre:list"))
        select.select_by_visible_text(genre)

    def select_type(self, type):
        select = Select(self.driver.find_element_by_name("addlayer.widgets.datatype:list"))
        select.select_by_visible_text(type)

    def select_resolution(self, resolution):
        select = Select(self.driver.find_element_by_name("addlayer.widgets.resolution:list"))
    ...
    def enter_start_date(self, day, month, year, description):
        ...
        self.driver.find_element_by_name("addlayer.widgets.temporal.start-day").send_keys(day)
        self.driver.find_element_by_name("addlayer.widgets.temporal.start-month").clear()
        self.driver.find_element_by_name("addlayer.widgets.temporal.start-month").send_keys(month)
        self.driver.find_element_by_name("addlayer.widgets.temporal.start-year").clear()
        self.driver.find_element_by_name("addlayer.widgets.temporal.start-year").send_keys(year)
        self.driver.find_element_by_name("addlayer.widgets.temporal.starttext").clear()
        self.driver.find_element_by_name("addlayer.widgets.temporal.starttext").send_keys(description)
    ...
    def enter_end_date(self, day, month, year, description):
        ...
        self.driver.find_element_by_name("addlayer.widgets.temporal.end-day").send_keys(day)
        self.driver.find_element_by_name("addlayer.widgets.temporal.end-month").clear()
        self.driver.find_element_by_name("addlayer.widgets.temporal.end-month").send_keys(month)
        self.driver.find_element_by_name("addlayer.widgets.temporal.end-year").clear()
        self.driver.find_element_by_name("addlayer.widgets.temporal.end-year").send_keys(year)
        self.driver.find_element_by_name("addlayer.widgets.temporal.endtext").clear()
        self.driver.find_element_by_name("addlayer.widgets.temporal.endtext").send_keys(description)

    def select_emission_scenario(self, emission_scenario):
        select = Select(self.driver.find_element_by_name("addlayer.widgets.emissionscenario:list"))
        select.select_by_visible_text(emission_scenario)

    def select_global_climate_model(self, global_climate_model):
        select = Select(self.driver.find_element_by_name("addlayer.widgets.gcm:list"))
